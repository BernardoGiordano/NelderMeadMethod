...
dove $\mu_{0}$ è la permeabilità magnetica nel vuoto,
$\mu_{0}=4{\pi}10^{-7} H/m$. \\
...
\end{align*}
\noindent
L'obiettivo del progetto della spira mancante risulta essere
la migliore approssimazione di un campo magnetico avente la
